...
import { MaintenanceProvider } from "./Maintenance.ts";
import { RepoProvider } from "./Repo.ts";

/**
 * The three `Reconciler`-backed resources this package defines. Every other
...
export const providers = () =>
  Layer.mergeAll(ConfigProvider(), RepoProvider(), MaintenanceProvider());
