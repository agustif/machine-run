...
const _bothTransport: McpServerProps = { tool: "claude", name: "x", command: "npx", url: "https://example.test" };
...
it.effect(
  ...
  () =>
    Effect.gen(function* () {
      ...
      yield* reconciler.apply({ props: stdioProps, observed: undefined, desired: stdioDesired }, applyCtx);
